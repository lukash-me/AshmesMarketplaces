...
public sealed class ParserCurrentProductDetailConfiguration : IEntityTypeConfiguration<ParserCurrentProductDetail>
{
    public void Configure(EntityTypeBuilder<ParserCurrentProductDetail> builder)
    {
        builder.ToTable("ParserCurrentProductDetails");
        ...
        builder.Property(x => x.DetailsHash).IsRequired().HasMaxLength(128).HasColumnName("details_hash");
        builder.Property(x => x.DetailsJson).IsRequired().HasColumnType("jsonb").HasColumnName("details_json");
