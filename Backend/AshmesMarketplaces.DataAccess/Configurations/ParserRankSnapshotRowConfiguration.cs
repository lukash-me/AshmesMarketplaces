...
public sealed class ParserRankSnapshotRowConfiguration : IEntityTypeConfiguration<ParserRankSnapshotRow>
{
    public void Configure(EntityTypeBuilder<ParserRankSnapshotRow> builder)
    {
        builder.ToTable("ParserRankSnapshotRows");
        ...
        builder.Property(x => x.PositionOnPage).IsRequired().HasColumnName("position_on_page");
        builder.Property(x => x.AbsolutePosition).IsRequired().HasColumnName("absolute_position");
        ...
        builder.Property(x => x.FetchStatus).IsRequired().HasMaxLength(64).HasColumnName("fetch_status");
        ...
        builder.HasIndex(x => new { x.RankContextId, x.AbsolutePosition });
