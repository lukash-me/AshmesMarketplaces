...
public sealed class RolesController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(PagedResponse<RoleListItemResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<PagedResponse<RoleListItemResponse>>> GetList([FromQuery] RoleListQuery query, CancellationToken cancellationToken)
    {
