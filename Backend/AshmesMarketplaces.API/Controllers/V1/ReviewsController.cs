...
public sealed class ReviewsController : ControllerBase
{
    ...
    [HttpGet]
    [ProducesResponseType(typeof(PagedResponse<ReviewListItemResponse>), StatusCodes.Status200OK)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
    public async Task<ActionResult<PagedResponse<ReviewListItemResponse>>> GetList([FromQuery] ReviewListQuery query, CancellationToken cancellationToken)
    {
        var result = await _reviewService.GetListAsync(query, cancellationToken);
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status409Conflict)]
    public async Task<ActionResult<ReviewResponse>> Update(Guid id, [FromBody] UpdateReviewRequest request, CancellationToken cancellationToken)
    {
