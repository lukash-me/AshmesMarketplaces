...
public sealed class PublicMarketConcentrationSnapshot
{
    public const string CompletedStatus = "completed";
    public const string FailedStatus = "failed";

    private PublicMarketConcentrationSnapshot() { }

    public PublicMarketConcentrationSnapshot(
        ...
        DateTime createdAtUtc)
    {
        ...
        TopN = topN;
        Status = FailedStatus;
        MarketConcentrationJson = "{}";
        PriceQualityPointsJson = "[]";
    ...
    public string MarketConcentrationJson { get; private set; } = "{}";
    public string PriceQualityPointsJson { get; private set; } = "[]";
    ...
    public void MarkCompleted(
        string marketConcentrationJson,
        string priceQualityPointsJson,
        int sampleSize,
        DateTime? latestObservedAtUtc,
        DateTime calculatedAtUtc,
        long durationMs)
    {
        if (string.IsNullOrWhiteSpace(marketConcentrationJson))
            throw new ArgumentException("Market concentration JSON is required.", nameof(marketConcentrationJson));
        if (string.IsNullOrWhiteSpace(priceQualityPointsJson))
            throw new ArgumentException("Price-quality points JSON is required.", nameof(priceQualityPointsJson));
        ...
        MarketConcentrationJson = marketConcentrationJson;
        PriceQualityPointsJson = priceQualityPointsJson;
