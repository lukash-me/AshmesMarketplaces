...
public sealed class UpdatePermissionCategoryRequestValidator : AbstractValidator<UpdatePermissionCategoryRequest>
{
    private const int NameMaxLength = 255;

    public UpdatePermissionCategoryRequestValidator()
    {
